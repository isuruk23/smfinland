                                ...
                                <tbody>
                                    @foreach($offerslist as $offerl)
                                        <tr>
                                            ...
                                            <a href="{{ route('offeredit', ['id' => $offerl->id, 'resortid' => $resortid]) }}" class="btn btn-warning btn-sm">Edit</a>

                                            
                                                <form action="{{ route('offers.destroy', $offerl->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
