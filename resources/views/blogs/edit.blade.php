...
<div class="container">
    ...
    <form action="{{ route('blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="summary" name="summary">{{ old('summary', $blog->summary ?? '') }}</textarea>
        ...
        <div class="form-group">
            ...
            @endif
            @if ($blog->image)
                <img src="{{ asset('public/storage/' . $blog->image) }}" alt="Image 2" style="max-width: 100px;">
            @endif
        </div>
