...
@section('content')
 ...
 <!-- ================ start banner area ================= -->	
 <section class="contact-banner-area" id="contact" style="background: url({{ asset('public/storage/images/contact-banner.avif') }}) center center no-repeat;background-size: auto;">
