...
<!-- ================ start banner area ================= -->	
<section class="contact-banner-area" id="contact" style='background: url("public/storage/images/maldives_holiday_packages.avif") center center no-repeat;background-size: auto;'>
